...
<template>
  <div class="login-container">
    <NSpin :show="pageLoading">
      <div class="login-content card-glass glow-effect">
        <!-- 左侧品牌区域 -->
...
.login-container::before {
  ...
  background: radial-gradient(1200px 600px at 10% 10%, rgba(99,102,241,0.25), transparent 60%),
              radial-gradient(900px 500px at 90% 10%, rgba(20,184,166,0.2), transparent 60%),
              radial-gradient(1000px 600px at 50% 90%, rgba(147,51,234,0.18), transparent 60%);
  filter: blur(20px);
  z-index: 0;
}
...
.login-container::after {
  ...
  left: -80px;
  bottom: -80px;
  background: radial-gradient(closest-side, rgba(59,130,246,0.35), rgba(59,130,246,0) 70%);
  filter: blur(8px);
...
html.dark .login-container::before {
  background: radial-gradient(1200px 600px at 10% 10%, rgba(99,102,241,0.18), transparent 60%),
              radial-gradient(900px 500px at 90% 10%, rgba(20,184,166,0.15), transparent 60%),
              radial-gradient(1000px 600px at 50% 90%, rgba(147,51,234,0.14), transparent 60%);
}
</style>
